...
export const StudyDetailsModal: React.FC<StudyDetailsModalProps> = ({
  ...
  const generalInfo = [
    ...
    { label: 'Study Date', value: new Date(data.studydate).toLocaleDateString() },
  ];
  ...
  const imageInfo = [
    ...
    { label: 'Reconstruction Diameter', value: `${data.reconstructiondiameter} mm` },
    { label: 'Distance Source to Detector', value: `${data.distancesourcetodetector} mm` },
    { label: 'Distance Source to Patient', value: `${data.distancesourcetopatient} mm` },
  ...
  const features = [
    ...
    { label: 'Pericardial Effusion', value: data.pericardial_effusion ? 'Yes' : 'No' },
    {
    ...
    { label: 'Pulmonary Fibrotic Sequela', value: data.pulmonary_fibrotic_sequela ? 'Yes' : 'No' },
    { label: 'Pleural Effusion', value: data.pleural_effusion ? 'Yes' : 'No' },
    { label: 'Mosaic Attenuation Pattern', value: data.mosaic_attenuation_pattern ? 'Yes' : 'No' },
    { label: 'Peribronchial Thickening', value: data.peribronchial_thickening ? 'Yes' : 'No' },
