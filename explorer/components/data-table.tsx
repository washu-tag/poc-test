  ...
  const columns = useMemo<MRT_ColumnDef<ImageRow>[]>(
    () => [
      ...
      },
      {
        ...
        Cell: ({ cell }) =>
          cell.getValue<Date>()?.toLocaleDateString(undefined, { timeZone: 'UTC' }),
        enableColumnFilterModes: false,
      },
      {
        header: 'Medical Material',
        id: 'medical_material',
        accessorFn: (row: ImageRow) => (row.medical_material ? 'true' : 'false'),
      ...
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.arterial_wall_calcification ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
      ...
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.pericardial_effusion ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.coronary_artery_wall_calcification ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
      ...
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.pulmonary_fibrotic_sequela ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
        ...
        id: 'pleural_effusion',
        accessorFn: (row: ImageRow) => (row.pleural_effusion ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.mosaic_attenuation_pattern ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.peribronchial_thickening ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
      ...
      },
      {
        ...
        accessorFn: (row: ImageRow) => (row.interlobular_septal_thickening ? 'true' : 'false'),
        filterVariant: 'checkbox',
        enableColumnFilterModes: false,
      },
      {
  ...
  const downloadAction = fileId
    ? () => (
        <>
          ...
          >
            <CSVDownloader type={Type.Button} filename={fileId} data={data} className="btn dark">
