 ...
 */
export class CustomWeaviateStore extends VectorStore {
  ...
  async similaritySearch(
    ...
    const embedding = query ? await this.embeddings.embedQuery(query) : [];
  ...
  static fromTexts(
    ...
    return CustomWeaviateStore.fromDocuments(docs, embeddings, args);
  }
