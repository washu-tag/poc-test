...
export function PureBlockStreamHandler({ setBlock, streamingData }: BlockStreamHandlerProps) {
  useBlockStream({
    streamingData,
    setBlock,
  });
...
function areEqual(prevProps: BlockStreamHandlerProps, nextProps: BlockStreamHandlerProps) {
