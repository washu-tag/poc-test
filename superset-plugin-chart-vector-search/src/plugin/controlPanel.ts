        ...
        [
          {
            ...
            config: {
              ...
              label: t('Embedding column'),
              description: t('Column containing vector embeddings'),
            },
          },
        ],
        ['adhoc_filters'],
        ...
        [
          {
            ...
            config: {
              ...
              step: 0.1,
              default: 0.5,
              label: t('Maximum distance'),
              description: t('The maximum cosine distance'),
            },
          },
        ],
        [
          {
            ...
            config: {
              ...
              label: t('Query'),
              default: '',
              description: t('The text to query'),
            },
          },
        ],
      ],
